function position(el, container) {
...
position.prototype = {
  ...
  _initEvent : function() {
    ...
    if (this.iframe) {
      this.iframe.addEventListener('load', function() {
        ...
        iframeContent.addEventListener('click', function() {
          self.createEvent('elementSelected');
        })
      });
    }
    ...
    this.el.addEventListener('elementSelected', function(e) {
  ...
  __animate : function() {    
    ...
    if (c_info && c_info.isMoving) {
      ...
      if (ghost_info && !this.isParked && !this.isSnap) {
        // this.container.dispatchEvent(new CustomEvent("cocreate-modalghost", {detail: ghost_info}));
        this._ghostProcess(ghost_info)
      }
  ...
  _selectElement: function(el) {
    ...
    if (this.el) {
      this.el.style.zIndex = this.SELECT_ZINDEX;
      this.el.classList.add('modal_selected');
  ...
  _releaseSelect: function() {
    ...
    el.style.zIndex = this.UNSELECT_ZINDEX;
    el.classList.remove("modal_selected");
  },
}
